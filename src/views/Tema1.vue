...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4(data-aos="fade-right") A continuación, se presentan las cualidades necesarias para desempeñarse adecuadamente como asesor o asesora telefónica:
    .row.justify-content-center.g-3
      .col-lg.mb-3
          .card-cualidad.h-100.text-center Ganas de aprender
      .col-lg.mb-3
          .card-cualidad.h-100.text-center Interés por el trabajo
      .col-lg.mb-3
          .card-cualidad.h-100.text-center Excelente trato con el cliente
      .col-lg.mb-3
          .card-cualidad.h-100.text-center Gran sentido del respeto
      .col-lg.mb-3
          .card-cualidad.h-100.text-center Empatía
      .col-lg.mb-3
          .card-cualidad.h-100.text-center Paciencia
    .row.mt-4
      p.mb-0(data-aos="fade-right") Las siguientes capacidades consolidan el desempeño profesional mediante una comunicación clara, organizada y centrada en el interlocutor.
    .row.bg-color-14
      .col-12
        .p-5
          .carousel-bg
      ...
      .col-lg-9.order-lg-1(data-aos="fade-left")
        .bg-color-15-1.p-4(data-aos="fade-left")
          .row.align-items-center.no-gutters.bg-color-4
            ...
            .col-lg-6
              p.mb-0s
                | Los <b>componentes de la comunicación telefónica</b> constituyen herramientas fundamentales que utiliza el asesor o la asesora con el propósito de lograr que la interacción con el cliente sea <b>agradable, eficaz y asertiva.</b>
        p Estos elementos permiten cumplir los objetivos planteados en cada contacto, ya sea la promoción de un producto o servicio o la solución de un problema manifestado por el cliente durante una llamada entrante. Una correcta aplicación de estos componentes favorece la construcción de una experiencia positiva, fortalece la imagen de la organización y contribuye a la satisfacción del cliente. Los componentes principales de la comunicación telefónica son:          
    ...
    .row.align-items-center      
      ...
      .col-lg-8(data-aos="fade-left")
        p La <b>articulación</b> se refiere a la posición y al movimiento de los órganos de la voz para la correcta pronunciación de vocales y consonantes. Una articulación adecuada facilita la comprensión del mensaje y evita malentendidos.
        .bg-color-7.p-4.mt-3
          p Recomendaciones clave:            
            ul.lista-ul.mt-3
              li.d-flex
                i.fas.fa-check-circle.me-2(style="color:#AD9721")
    ...
    .row.align-items-center
      ...
      .col-lg-7(data-aos="fade-left")
        p El <b>volumen</b> representa la intensidad con la que se emite la voz y, en la comunicación telefónica, constituye la única forma de llegar directamente al oído del interlocutor. Por ello, debe mantenerse en un nivel <b>normal y equilibrado</b>, evitando los extremos.
        .bg-color-7.p-4.mt-3
          p Recomendaciones clave:
            ul.lista-ul.mt-3
              li.d-flex
    ...
    .row.align-items-center
      ...
      .col-lg-8(data-aos="fade-left")
        p <b>La elocución</b> es la <b>velocidad</b> con la que se transmite el mensaje durante la llamada. Una velocidad adecuada favorece la comprensión y transmite seguridad.
        .bg-color-7.p-4.mt-3
          p Recomendaciones clave:
            ul.lista-ul.mt-3
              li.d-flex
      ...
      .col-lg-12(data-aos="fade-right")
        ...
        .row.align-items-center.mb-0
          .col-lg-10
            ...
            p.mt-3(data-aos="fade-right") A continuación, se presenta lo que debe contener y lo que debe evitar el lenguaje utilizado durante la comunicación telefónica.          
          .col-lg-2
            figure.mb-0
    ...
    .row
      ...
      p(data-aos="fade-right") La <b>escucha activa</b> es la habilidad de <b>escuchar no solo las palabras</b>, sino también las <b>ideas, intenciones y pensamientos</b> que subyacen en el discurso del interlocutor. Además, implica demostrar de manera explícita que el mensaje ha sido comprendido, lo cual permite <b>crear un vínculo con el cliente</b> y ofrecer un servicio de calidad. A partir de este concepto, la escucha activa se compone de <b>elementos decisivos</b> que facilitan el desempeño eficaz del asesor o asesora telefónica. A continuación, se describen los elementos de la escucha activa y la función que cumple cada uno dentro del proceso comunicativo.
    .row.bg-color-14
      .col-12
        .p-5
          .bg-full-width.mt-5
    ...
    .row(data-aos="fade-right")
        p Los comportamientos del mal oyente y del buen oyente son:
        .bg--img_03
    ...
    .row(data-aos="fade-right")
        p El uso adecuado del lenguaje verbal y la práctica constante de la escucha activa permiten al asesor telefónico comprender al cliente, responder con eficacia y fortalecer la imagen de la empresa.
        .bg-full-width.mt-4
          .px-4.px-md-5.pb-md-3
          .titulo-con-imagen.mb-5(data-aos="fade-right")                     
              h3.titulo-purpura El silencio
    .row(data-aos="fade-right")
        p Dentro de la comunicación telefónica, existe un aspecto de gran relevancia que forma parte de la <b>escucha activa: el silencio</b>. El asesor o asesora debe saber <b>ser prudente y respetar los silencios o pausas naturales</b> que se producen durante una conversación, ya que estos contribuyen a que la comunicación sea considerada <b>óptima y profesional.</b>
    ...
    .row.mt-4(data-aos="fade-right")
        p El túnel oscuro es una de las causas más comunes de insatisfacción en la atención telefónica, ya que rompe la conexión comunicativa y afecta negativamente la percepción del servicio. La importancia del silencio en la comunicación telefónica
    .bg-full-width.mt-5
      .px-4.px-md-5.pb-md-3             
        .carousel-bg
          .row.justify-content-center.mb-5.align-items-center
